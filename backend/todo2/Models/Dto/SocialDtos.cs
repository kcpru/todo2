...
public record PostResponse(Guid Id, string TodoListAsJson, string Content, int LikesCount, bool IsLiked, DateTime CreatedAt, DateTime UpdatedAt, IReadOnlyList<PostCommentResponse> Comments);
